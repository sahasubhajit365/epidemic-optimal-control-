...
- Early interventions reduce peak infections (IPP) but may increase total infections (EFS) due to rebound.
- Later interventions reduce EFS but may lead to a higher IPP, stressing healthcare systems.
...
- Analyzes how conflict varies with intervention duration (τ)  
...
- Identifies feasible weight combinations under a given peak-capacity constraint  
